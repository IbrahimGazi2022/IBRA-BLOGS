...
const AuthorsList = () => {
    return (
        <div className="relative z-10 bg-[#081838]">
            <div className="space-y-4 md:space-y-4 px-4 sm:px-6 lg:px-8 py-4 md:py-4">
                {AuthorData.map((author, index) => (
                    <div
                        key={index}
                        className='flex flex-col lg:flex-row-reverse max-w-[1280px] min-h-[400px] md:min-h-[550px] py-8 md:py-4 gap-8 md:gap-6 mx-auto mb-2 md:mb-2 relative'>
                        ...
                        <div className='lg:flex-1 flex flex-col justify-center px-2 sm:px-0'>
                            ...
                            <h1 className="text-white text-2xl sm:text-3xl font-bold tracking-wide mt-2">
                                {author.title}
                            </h1>
